module singleplayer_paid_nft {
    ...
    struct SINGLEPLAYER_NFT has drop {}

    /// Initialisierung - wird einmal beim Deployment aufgerufen
    fun init(otw: SINGLEPLAYER_NFT, ctx: &mut TxContext) {
        ...
        let display = display::new_with_fields<PixelNFT>(
